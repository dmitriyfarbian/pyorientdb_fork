...
from ..constants import DB_OPEN_OP, DB_TYPE_DOCUMENT, DB_COUNT_RECORDS_OP, FIELD_BYTE, FIELD_INT, \
    ...
    VERSION, DB_TYPES, DB_CLOSE_OP, DB_EXIST_OP, STORAGE_TYPE_PLOCAL, STORAGE_TYPE_MEMORY, \
    DB_CREATE_OP, DB_DROP_OP, DB_RELOAD_OP, DB_SIZE_OP, DB_LIST_OP, STORAGE_TYPES, FIELD_LONG
...
class DbExistsMessage(BaseMessage):
    def __init__(self, _orient_socket):
        ...
        if self.get_protocol() > 16:  # 1.5-SNAPSHOT
            ...
            self._storage_type = STORAGE_TYPE_MEMORY
